define(["react","jquery","jqueryui","utilities/ModuleManager","utilities/QueryStringReader",
  ...
  ,"modules/PageRenderer/PageRenderer"],
    function(React,$,jqui,moduleManager,queryStringReader,
      pageLoader,cssManager,devModules, uiModules) {
        var OmnyModuleList = React.createClass({displayName: "OmnyModuleList",
            ...
            render: function() {
                return React.createElement("div", null, 
                    this.props.modules.map(function(module, i){
                        return React.createElement("div", {className: "omny-draggable-module", "data-omny-module": module.module, key: i}, module.name);
                    }), 
                    this.state.uimodules.map(function(module, i){
                         return React.createElement("div", {className: "omny-draggable-module", "data-omny-module": module.name, "data-omny-url": module.url, key: i}, module.name);
                     }), 
                    this.state.devmodules.map(function(module, i){
                         return React.createElement("div", {className: "omny-draggable-module", "data-omny-module": module.name, "data-omny-url": module.url, key: i}, module.name);
                     }), 

                    React.createElement("button", {className: "omny-save-button"}, "Save")
                );
              }
        });
        var OmnyPageMaster = React.createClass({displayName: "OmnyPageMaster",
          componentDidMount: function(){
            var node = this.getDOMNode();
            ...
            pageLoader.loadPage(pageName,function(pageData, siteDetails) {
                React.render(React.createElement(OmnyPageRenderer, {key: "omny-page", editable: "true", pagename: pageName, siteDetails: siteDetails, pagedata: pageData}), pageNode[0]);
                $(".omny-module-section .omny-module-section").sortable({
                    ...
                    stop: function(event, ui) {
                        if (ui.item.hasClass("omny-draggable-module")) {
                            ...
                            React.render(React.createElement(OmnyModuleRenderer, {module: mod, editable: true}),x);
            ...
            React.render(React.createElement(OmnyModuleList, {key: "omny-default-modules", modules: moduleManager.getDefaultModules()}), sideBar[0]);
          },
          render: function() {
            return React.createElement("div", null, 
                React.createElement("div", {key: "omny-sidebar", className: "omny-module-sidebar"}), 
                React.createElement("div", {className: "omny-page"})
            );
          }
        });
        function PageMaster(data) {
            this.render = function(element) {
                React.render(React.createElement(OmnyPageMaster, null), element);
            }
        }
